...
class JobQueueManager {
  private dataSync: Queue<DataSyncJob>;
  private reportGeneration: Queue<ReportGenerationJob>;
  private cleanup: Queue<CleanupJob>;
  ...
  constructor() {
    ...
    // Initialize queues
    this.dataSync = new Bull('data-sync', redisConfig);
    this.reportGeneration = new Bull('report-generation', redisConfig);
    this.cleanup = new Bull('cleanup', redisConfig);
    this.notifications = new Bull('notifications', redisConfig);
