...
import { BarChart3, Shield, Users, TrendingUp, Zap, CheckCircle } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Deep insights into user activity and license utilization patterns'
    },
    {
      icon: Users,
      title: 'User Management',
      description: 'Track individual user engagement and identify optimization opportunities'
    },
    {
      icon: TrendingUp,
      title: 'Usage Trends',
      description: 'Monitor usage patterns over time with detailed reporting capabilities'
    },
    {
      icon: Zap,
      title: 'Cost Optimization',
      description: 'Identify unused licenses and potential cost savings opportunities'
    }
  ];
          ...
          <div className="flex flex-col justify-center max-w-lg mx-auto">
            <div className="mb-8">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  <h1 className="text-2xl font-bold">License Utilization Inspector</h1>
            ...
            <div className="lg:hidden text-center mb-8">
              <div className="flex items-center justify-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">License Utilization Inspector</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Sign in with your Salesforce admin account to access your organization's license analytics
                </p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <div className="text-center">
                  <p className="text-xs text-gray-500 mb-4">Trusted by Salesforce administrators worldwide</p>
